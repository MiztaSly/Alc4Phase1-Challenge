...
public class TwitterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(TwitterActivity.this);
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                ...
                Toast.makeText(TwitterActivity.this, R.string.page_access_error, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void loadResource() {
        ...
        webView.loadUrl(getString(R.string.twitter_handle_mizta));
